...
print("Checksum from image : {}".format(readChecksum(cmos_image_path, 0x75BE66F).hex(' ')))
...
for i in range(len(algorithm_list)):
	checksum, checksum_start_offset, checksum_end_offset, num_sums, last_byte = calculateChecksum(cmos_image_path, 0x075be85b, checksum_lengths[i], algorithm_list[i], 'little', 0x0)
